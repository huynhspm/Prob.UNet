...
def get_dataloader(args):
    if args.dataset == "lidc":
        ...
        train_dataset, val_dataset = get_msmri_dataset(args)
    elif "isic" in args.dataset:
        if args.dataset == "isic2016":
            train_dataset, val_dataset = get_isic2016_dataset(args)
        elif args.dataset == "isic2018":
            train_dataset, val_dataset = get_isic2018_dataset(args)
